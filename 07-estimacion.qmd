...
![](img/estimacion/obtencion-muestra.svg)
:::
...
::: {.content-visible when-format="html"}
![](img/estimacion/distribucion_media.svg){fig-alt="Distribución de la media de una muestra de tamaño 2." fig-align="center" width=80%}
:::
:::
...
::: {.content-visible when-format="html"}
![](img/estimacion/estimador-estimacion){fig-alt="Diferencia entre estimador y estimación de un parámetro poblacional." fig-align="center"}
:::
:::
...
:::{.content-visible when-format="html"}
![](img/estimacion/estimacion-puntual-intervalo.svg){fig-alt="Estimación puntual y por intervalos de un parámetro poblacional." fig-align="center"}
:::
...
\begin{center}
\color{red}{_¿Cuál es el mejor estimador?}_
\end{center}
...
::: {.content-visible when-format="html"}
![](img/estimacion/estimadores-sesgados-insesgados){fig-alt="Distribución de la media del número de hijos de dos muestras de tamaños 30 y 100." fig-align="center"}
:::
...
:::{.content-visible when-format="html"}
:::{layout-ncol="2"}
![](img/estimacion/estimadores-consistentes.svg){fig-alt="Distribución de estimadores consistentes." fig-align="center"}

![](img/estimacion/estimadores-consistentes-sesgados.svg){fig-alt="Distribución de estimadores consistentes segados." fig-align="center"}
:::
:::
...
::: {.content-visible when-format="html"}
![](img/estimacion/estimador-eficiente-sesgado.svg){fig-alt="Distribución de estimadores insesgados y eficientes sesgados." fig-align="center"}
:::
...
:::{.content-visible when-format="html"}
![](img/estimacion/estimador-asintoticamente-normal.svg){fig-alt="Distribución de estimadores asintóticamente normales." fig-align="center"}
:::
...
Lo que si se deduce de la definición es que el $(1-\alpha)\%$ de los intervalos correspondientes a las todas las posibles muestras aleatorias, contendrán al parámetro. Es por eso que se habla de \color{red}{confianza} y no de probabilidad.
...
::: {.content-visible when-format="html"}
![](img/estimacion/extremos_intervalos){fig-alt="Cálculo de los límites del intervalo." fig-align="center" width=70%}
:::
