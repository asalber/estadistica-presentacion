...
![](img/contrastes/regiones_bilateral.svg){fig-alt="Regiones de un contraste bilateral" width="700" fig-align="center" width=80%}

- Contraste unilateral de menor $H_0:\ \theta=\theta_0$ &H_1:\ \theta<\theta_0$.
![](/img/contrastes/regiones_unilateral_menor.svg){fig-alt="Regiones de un contraste unilateral de menor" width="700" fig-align="center" width=80%}

- Contraste unilateral de mayor $H_0:\ \theta=\theta_0$ $H_1:\ \theta>\theta_0$.
![](/img/contrastes/regiones_unilateral_mayor.svg){fig-alt="Regiones de un contraste unilateral de mayor" width="700" fig-align="center" width=80%}

---

:::{#exm-regiones-aceptacion-rechazo}
...
![](/img/contrastes/regiones_contraste_proporcion_hombres.svg){fig-alt="Regiones de un contraste sobre la proporción de hombres en una muestra de tamño 10." width="700" fig-align="center" width=80%}
:::
...
:::{#def-riesgos-alfa-beta}
## Riesgos $\alpha$ y $\beta$
En un contraste de hipótesis, se define el _riesgo_ $\alpha$ como la máxima probabilidad de cometer un error de tipo I, es decir,
...
:::{.columns}
::: {.column width="50%"}
![](/img/contrastes/regiones_bilateral_normal.svg){fig-alt="Regiones de un contraste bilateral en una distribución normal" fig-align="center" width=100%}
:::

::: {.column width="50%"}
![](/img/contrastes/regiones_unilateral_mayor_normal.svg){fig-alt="Regiones de un contraste unilateral de mayor en una distribución normal" fig-align="center" width=100%}
:::
:::
...
:::{#exm-regiones-aceptacion-rechazo}
Siguiendo con el contraste sobre la proporción de hombres de una población, como el estadístico del contraste sigue una distribución binomial $X\sim B(10,0.5)$, si se decide rechazar la hipótesis nula
...
![](/img/contrastes/regiones_contraste_proporcion_hombres_2.svg){fig-alt="Regiones de un contraste sobre la proporción de hombres en una muestra de tamño 10." width="700" fig-align="center" width=80%}
:::
...
:::{#def-potencia-contraste}
## Potencia de un contraste
La _potencia_ de un contraste de hipótesis se define como
...
## Relación del riesgo $\beta$ y el tamaño del efecto $\delta$ {auto-animate=true}
...
![](/img/contrastes/riesgo_beta_tamaño_efecto_pequeño.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto pequeño." fig-align="center"}

## Relación del riesgo $\beta$ y el tamaño del efecto $\delta$ {auto-animate=true}

El riesgo $\beta$ depende directamente de la mínima diferencia $\delta$ que se desea detectar con respecto al valor del parámetro que establece la hipótesis nula.

![](/img/contrastes/riesgo_beta_tamaño_efecto_grande.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto grande." fig-align="center"}

---

:::{#exm-potencia-contraste}
...
## Relación entre los riesgos $\alpha$ y $\beta$ {auto-animate=true}

Los riesgos $\alpha$ y $\beta$ están enfrentados, es decir, cuando uno aumenta el otro disminuye y viceversa.

![](/img/contrastes/relacion_riesgos_alpha_pequeño.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto pequeño." fig-align="center"}

## Relación entre los riesgos $\alpha$ y $\beta$ {auto-animate=true}

Los riesgos $\alpha$ y $\beta$ están enfrentados, es decir, cuando uno aumenta el otro disminuye y viceversa.

![](/img/contrastes/relacion_riesgos_alpha_grande.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto grande." fig-align="center"}

---

:::{#exm-relacion-riesgos-alfa-beta}
...
## Relación de los riesgos de error y el tamaño muestral {auto-animate=true}
...
![](/img/contrastes/relacion_riesgos_tamaño_muestral_pequeño.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto grande." fig-align="center"}

## Relación de los riesgos de error y el tamaño muestral {auto-animate=true}

Los riesgos de error también dependen el tamaño de la muestra, ya que al aumentar el tamaño de la muestra, la dispersión del estadístico del contraste disminuye y con ello también lo hacen los riesgos de error.

![](/img/contrastes/relacion_riesgos_tamaño_muestral_grande.svg){.r-stretch fig-alt="Riesgo beta para un tamaño del efecto grande." fig-align="center"}

---

:::{#exm-relacion-riesgos-tamaño-muestral}
...
![](/img/contrastes/potencia.svg){width=80% fig-alt="Curva de potencia para muestras de distinto tamaño." fig-align="center"}
:::
...
### {.scrollable}
:::{#exm-contraste-media-normal-varianza-desconocida}
...
:::{#exm-tamaño-muestral-contraste-media}
Se ha visto en el ejemplo anterior que la potencia del contraste para detectar una diferencia en la nota media de 1 punto era del $69.96\%$.
...
## Contraste para la media de una población con varianza desconocida y muestras grandes {.smaller}
...
## Contraste para la varianza de una población normal {.smaller}
...
## Contraste de comparación de medias de dos poblaciones normales con varianzas conocidas {.smaller}
...
## Contraste de comparación de medias de dos poblaciones normales con varianzas desconocidas e iguales {.smaller}
...
:::{#exm-contraste-diferencia-medias-normales-varianzas-desconocidas-iguales}
...
## Contraste de comparación de varianzas de dos poblaciones normales {.smaller}
...
:::{#exm-contraste-comparacion-varianzas}
...
## Contraste de comparación de proporciones de dos poblaciones {.smaller}
...
:::{#exm-contraste-diferencia-proporciones}
...
:::{#exm-contraste-mediante-intervalos-confianza}
